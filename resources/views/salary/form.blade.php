<div class="form-group {{ $errors->has('user_id') ? 'has-error' : ''}}">
    ...
    {!! Form::select('user_id',$users , old('users')??isset($salary)?$salary->user->id:null, ['class' => 'form-control', 'required' => 'required', 'data-toggle'=>'select2']) !!}
...
<div class="form-group {{ $errors->has('over_days') ? 'has-error' : ''}}">
    ...
    {!! Form::text('over_days', null, ['class' => 'form-control', 'required' => 'required', 'data-parsley-type' => 'integer']) !!}

! function (a) {
    ...
    e.prototype.initSelect2 = function () {
        ...
        var e = {};
        a('[data-toggle="touchspin"]').each(function (n, i) {
            var t = a.extend({}, e, a(i).data());
            a(i).TouchSpin(t)
        })
...
function (a) {
    ...
    "use strict";
    var a = $.map(countries, function (a, e) {
        return {
            value: a,
            data: e
        }
    ...
    $.mockjax({
        ...
        response: function (e) {
            var n = e.data.query,
                i = n.toLowerCase(),
                t = new RegExp("\\b" + $.Autocomplete.utils.escapeRegExChars(i), "gi"),
                o = {
                    query: n,
                    suggestions: $.grep(a, function (a) {
